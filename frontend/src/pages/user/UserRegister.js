            ...
            <div className="card shadow" style={{ borderRadius: '1rem', border: 'none' }}>
              <div className="card-body p-5">
                ...
                <form method='POST' onSubmit={HandleRegisterForm}>
                  ...
                  <button className="btn btn-dark btn-lg btn-block" style={{ fontSize: '1.1rem' }} type="submit">Register Now</button>
                </form>

                <hr className="my-4" />

                <p className="text-center mb-0" style={{ fontSize: '1rem'  }}> Already Have An Account?<Link to='/login' style={{color:'#023020'}}> Login</Link></p>
              </div>
            </div>
          </div>
        </div>
